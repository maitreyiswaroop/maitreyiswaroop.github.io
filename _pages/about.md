...
- **January 2026:** Poster at the *Bridging Prediction and Intervention Problems in Social Systems* workshop at Simons Institute in Berkeley. [[poster]]({{ base_path }}/files/CRL-HTE-Simons-poster.pdf){:target="_blank" rel="noopener"} [[preprint]]({{ base_path }}/files/_arXiv__Representation_Learning_HTE_Estimation.pdf){:target="_blank" rel="noopener"} (arXiv link coming soon)
